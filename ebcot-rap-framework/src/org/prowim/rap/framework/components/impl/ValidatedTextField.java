...
/**
 * 
 * This shows a normal text field. You can set the minimal, maximal and re1uired <br/>
 * values about constraint class.
 * 
 * 
 * @author Maziar Kkodaei
 * @version $Revision: 4998 $
 */
public class ValidatedTextField extends Text
{
     ...
     */
    public ValidatedTextField(Composite parent, final Constraint constraint)
    {
        ...
        if (constraint.isRequired() && this.getText().equals(""))
        {
            ...
            ValidatedTextField.this.setBackground(ColorManager.REQUIRED_FIELD);
        }
        ...
        this.addVerifyListener(new VerifyListener()
        {
            ...
            public void verifyText(VerifyEvent event)
            {
                ...
                if (verified.hasError())
                    ...
                    ValidatedTextField.this.setBackground(ColorManager.BACKGROUND_COLOR);
            }
     ...
     * @param parent Composite, where this component shows
     * @param constraint A controller, which set the values min, max and required
     * @param style the password style SWT.PASSWORD
     */
    public ValidatedTextField(Composite parent, final Constraint constraint, int style)
    {
        super(parent, SWT.SINGLE | SWT.BORDER | style);

...
/**
 * 
 * Frame to administer cleaning functions.
 * 
 * @author Oliver Wolff
 * @version $Revision$
 * @since 1.0
 */
public class CleaningFrame extends JFrame
{

    private static final long serialVersionUID = 1L;
    private final JTextField  server           = new JTextField();
    private final String      wsdlSuffix       = "ProWimServices/AdminBean?wsdl";
    ...
    private void init()
    {
        server.setText("prowim-2.ebcot.info");
    }
    ...
    private void build()
    {
        ...
        setTitle("Aufräum tool für Ontologien");
    ...
    private JPanel buildContent()
    {
        ...
        builder.appendSeparator("Hauptmen�");
        builder.nextLine();
        builder.append(new JLabel("Server:"));
        builder.append(server);
        builder.nextLine();
        builder.append(new JLabel("Bereinigung der Ontologie:"));
    ...
    private void createActions()
    {
        ...
        }, "STARTEN", null, null, null, "Tauscht alle \"-Zeichen mit '-Zeichen innerhalb aller Modellregeln aus.");
    ...
    /**
     * 
     * Exchanges all "-chars into '-chars. Just now only executing in modelrules.
     */
    protected void doCleaning()
    {
        // call the cleaning service
        MigrationController controller = new MigrationController();
        String sourceServerName = this.server.getText();

        String wsdl = urlPrefix + sourceServerName + separator + wsdlSuffix;
        controller.connect(wsdl);
        try
        {
            controller.clean();
            JOptionPane
                    .showMessageDialog(this,
                                       "Es wurden innerhalb der Modellregeln alle \"-Zeichen in '-Zeichen konvertiert.\nAchten Sie bitte auf die erzeugten Logdateien!");
        }

 ...
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/services/interceptors/BeansSecurityInterceptor.java $
...
public class BeansSecurityInterceptor
{
    ...
    private boolean intercept(String methodname, String classname) throws OntologyErrorException
    {
        ...
        if (authorization != null)
        {
            ...
            {
                return !authorization.isAuthorized() && this.checkNotAdminUser();
            }
        }
        else
        {
     ...
     * @return
     */
    private boolean checkNotAdminUser()
    {
        /**
         * TODO: <br>
         * 1. getPossibleModifier : get the objID of the modifier and the classname of the modifier.<br>
         * 2. If the modifier is a person : check if the caller is the same person <br>
         * 3. else if the caller is a role: check if the caller "besetzt" this role.<br>
         * 4. else if the caller is a OE: check if the caller is "Mit_Glied_von" this OE.<br>
         * 5. else throws not supported
         * 
         */
        return true;
    }

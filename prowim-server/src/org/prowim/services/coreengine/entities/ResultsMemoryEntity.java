 ...
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/services/coreengine/entities/ResultsMemoryEntity.java $
...
/**
 * Provides an interface with access to the resultsmemory data stored in the ontology.
 * 
 * @author Saad Wardi
 * @version $Revision: 4510 $
 */
@Local
public interface ResultsMemoryEntity
{
    /**
     * Gets the resultsmemory with the ID.
     * 

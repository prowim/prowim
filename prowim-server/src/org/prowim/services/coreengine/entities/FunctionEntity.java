 ...
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/services/coreengine/entities/FunctionEntity.java $
...
/**
 * Provides an interface with access to the function data stored in the ontology.
 * 
 * @author Saad Wardi
...
{
    /**
     * Gets a {@link Function}.
     * 
     * @param id not null FunctionEntity ID.
     * @return not null {@link FunctionEntity}.

 ...
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/services/coreengine/entities/WorkEntity.java $
...
/**
 * Provides an interface with access to the work (tätigkeit) data stored in the ontology.
 * 
 * @author Saad Wardi

 ...
 * $LastChangedBy: wardi $
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/services/coreengine/entities/impl/DefaultProductEntity.java $
...
/**
 * Implements {@link ProductEntity}.
 * 
 * @author Saad Wardi
 * @version $Revision: 4816 $
 */
@Stateless
public class DefaultProductEntity implements ProductEntity
{
    private static final Logger LOG = Logger.getLogger(DefaultProductEntity.class);
     ...
     * {@inheritDoc}
     * 
     * @see org.prowim.services.coreengine.entities.ProductEntity#getProduct(java.lang.String)
     */
    @Override
    public Product getProduct(String id) throws OntologyErrorException
    {
        Validate.notNull(id);
        final RecordSet records = processEngine.getProduct(id);
        ...
        if (records.getNoOfRecords() > 0)
        {
            ...
            Product product = DefaultDataObjectFactory.createProduct(id, name, createTime);

...
set JAVA_OPTS=%JAVA_OPTS% -Djava.endorsed.dirs=%JBOSS_ENDORSED_DIRS% -Dorg.jboss.resolver.warning=true -Dprowim.appserver.url=locahost -Dsun.jnu.encoding=UTF-8 -Dfile.encoding=UTF-8 -Dprowim.customer.id=405328e8-fae5-4eef-8a20-67ad138cc7af -Dorg.eclipse.rwt.enableUITests=true

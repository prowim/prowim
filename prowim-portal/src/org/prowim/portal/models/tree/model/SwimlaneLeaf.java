...
/**
 * Leaf model for swimlanes.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0a10
 */
public class SwimlaneLeaf extends DefaultLeaf
{
     ...
     * Description.
     * 
     * @param id id of leaf. Not null.
     * @param name name leaf. Not null.
     */
    public SwimlaneLeaf(String id, String name)
    {
        super(id, name);
        setImage(imageKey);
    }
    ...
    public SwimlaneLeaf()
    {
        super(GlobalConstants.ROOT_MODEL, Resources.Frames.Global.Texts.SWIMLANE.getText());
        setImage(imageKey);
    }

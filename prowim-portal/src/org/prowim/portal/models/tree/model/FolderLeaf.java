...
/**
 * Model for root domain. This is only to use as root leaf to add {@link DomainLeaf}.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0
 */
public class FolderLeaf extends DefaultLeaf
{
    /** Image of model */
     ...
     */
    public FolderLeaf(String id, String name)
    {
        super(id, name);
        setImage(imageKey);
    }

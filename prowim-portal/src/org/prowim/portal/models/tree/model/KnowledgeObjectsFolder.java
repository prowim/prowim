...
/**
 * Model for all knowledge objects. This is should used only as root for a list of {@link KnowledgeObjectLeaf}.
 * 
 * @author Maziar KHodaei
 * @version $Revision$
 * @since 2.0
 */
public class KnowledgeObjectsFolder extends DefaultLeaf
{
    /** Image of model */
     ...
     */
    public KnowledgeObjectsFolder(String id, String name)
    {
        super(id, name);
        setImage(imageKey);
    }
     ...
     * 
     */
    public KnowledgeObjectsFolder()
    {
        super(GlobalConstants.ROOT_MODEL, Resources.Frames.Knowledge.Texts.KNOW_OBJECTS.getText());
        setImage(imageKey);
    }

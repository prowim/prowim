 ...
 * $LastChangedRevision$
 *------------------------------------------------------------------------------
 * (c) 18.01.2011 Ebcot Business Solutions GmbH. More info: http://www.ebcot.de
...
/**
 * Root leaf for knowledge domain. This is only to use as root for {@link DomainLeaf}. Other wise use {@link DomainLeaf}.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.3
 */
public class DomainFolder extends DefaultLeaf
{
    /** Image of model */
    private final Image imageKey = Resources.Frames.Tree.Images.TREE_FOLDER.getImage();

    /**
     * Description. Each knowledge domain model should has an unique ID and a name
     * 
     * @param id ID of Model
     * @param name Name of Model
     */
    public DomainFolder(String id, String name)
    {
        super(id, name);
        setImage(imageKey);
    }

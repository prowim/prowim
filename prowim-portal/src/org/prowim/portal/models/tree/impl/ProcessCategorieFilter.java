...
/**
 * Filters only the leaf from type {@link ProcessTypeEditorLeaf} and {@link ProcessTypeRootLeaf}. Other nodes will not be shows.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0
 */
public class ProcessCategorieFilter extends ViewerFilter
{
    /**
     * {@inheritDoc}
     * 
    ...
    {
        return ((element instanceof ProcessTypeEditorLeaf) || (element instanceof ProcessTypeRootLeaf) || (element instanceof ProcessTypeLeaf));
    }

...
/**
 * Sorts the order of nodes in table in process browser view.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0
 */
public class ProcessBrowserTableSorter extends ViewerSorter
{
    ...
    public int category(Object element)
    {
        if (element instanceof ProcessLeaf)
            return 1;
        if (element instanceof ProcessTypeLeaf)
            return 2;

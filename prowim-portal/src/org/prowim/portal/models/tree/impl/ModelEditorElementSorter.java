 ...
 * $LastChangedRevision$
 *------------------------------------------------------------------------------
 * (c) 06.08.2010 Ebcot Business Solutions GmbH. More info: http://www.ebcot.de
...
/**
 * Element sorter for the tree in {@link ProcessModelEditorView}
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0a9
 */
public class ModelEditorElementSorter extends ViewerSorter
{

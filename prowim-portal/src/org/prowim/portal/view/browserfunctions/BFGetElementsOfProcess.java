...
/**
 * Returns all {@link ProcessElement}s to given {@link Process}id.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0a9
 */
public class BFGetElementsOfProcess extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFGetElementsOfProcess(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        String elementID = ArgumentValidator.convert(arguments).get(0);

        return MainController.getInstance().getElementsOfProcess(elementID).toArray();
    }

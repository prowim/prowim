...
/**
 * Checks if the given {@link Process} is approved.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.2.0
 */
public class BFIsProcessApproved extends AbstractModelEditorFunction
{
     ...
     */
    public BFIsProcessApproved(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().isProcessApproved(argList.get(0));
    }
}

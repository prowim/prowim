...
/**
 * Exposes {@link MainController#removeRelationValue(String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFRemoveRelationValue extends AbstractModelEditorFunction
{
     ...
     */
    BFRemoveRelationValue(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().removeRelationValue(argList.get(0), argList.get(1));
        return null;
    }
}

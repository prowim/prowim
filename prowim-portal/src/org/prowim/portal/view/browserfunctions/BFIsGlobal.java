...
/**
 * Exposes {@link MainController#isGlobal(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFIsGlobal extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFIsGlobal(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().isGlobal(argList.get(0));
    }
}

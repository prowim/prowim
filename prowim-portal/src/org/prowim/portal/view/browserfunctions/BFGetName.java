...
/**
 * Exposes {@link MainController#getName(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFGetName extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFGetName(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().getName(argList.get(0));
    }
}

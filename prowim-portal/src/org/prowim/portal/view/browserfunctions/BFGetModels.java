...
/**
 * Exposes {@link MainController#getModels()} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFGetModels extends AbstractModelEditorFunction
{
     ...
     */
    BFGetModels(ModelEditor modelEditor, String name)
    {
    ...
    {
        return MainController.getInstance().getModels();
    }
}

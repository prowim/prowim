...
/**
 * Checks is the {@link Process} is a process landscape.
 * 
 * @author Maiziar Khodaei
 * @version $Revision$
 * @since 2.2.0
 */
public class BFIsProcessLandscape extends AbstractModelEditorFunction
{
     ...
     */
    public BFIsProcessLandscape(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().isProcessLandscape(argList.get(0));
    }

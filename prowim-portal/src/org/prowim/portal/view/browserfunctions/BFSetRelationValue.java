...
/**
 * Exposes {@link MainController#setRelationValue(String, String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFSetRelationValue extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFSetRelationValue(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().setRelationValue(argList.get(0), argList.get(1), argList.get(2));
        return null;
    }
}

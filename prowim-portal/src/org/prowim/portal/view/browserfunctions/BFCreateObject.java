...
/**
 * Exposes {@link MainController#createObject(String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFCreateObject extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFCreateObject(ModelEditor modelEditor, String name)
    {
    ...
    {
        return MainController.getInstance().createObject((String) arguments[0], (String) arguments[1]);
    }
}

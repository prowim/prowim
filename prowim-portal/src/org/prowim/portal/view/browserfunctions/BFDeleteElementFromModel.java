...
/**
 * Exposes {@link MainController#deleteElementFromModel(String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFDeleteElementFromModel extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFDeleteElementFromModel(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().deleteElementFromModel(argList.get(0), argList.get(1));
        return null;
    }
}

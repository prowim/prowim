...
/**
 * Exposes {@link MainController#deleteObject(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFDeleteObject extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFDeleteObject(ModelEditor modelEditor, String name)
    {
    ...
    {
        MainController.getInstance().deleteObject((String) arguments[0]);
        return null;
    }
}

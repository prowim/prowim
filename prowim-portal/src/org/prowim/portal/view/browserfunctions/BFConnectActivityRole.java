...
/**
 * Exposes {@link MainController#connectActivityRole(String, String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFConnectActivityRole extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFConnectActivityRole(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().connectActivityRole(argList.get(0), argList.get(1), argList.get(2));
        return null;
    }
}

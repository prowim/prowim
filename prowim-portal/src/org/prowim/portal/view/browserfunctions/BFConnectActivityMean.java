...
/**
 * Exposes {@link MainController#connectActivityMean(String, String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFConnectActivityMean extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFConnectActivityMean(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().connectActivityMean(argList.get(0), argList.get(1), argList.get(2));
        return null;
    }
}

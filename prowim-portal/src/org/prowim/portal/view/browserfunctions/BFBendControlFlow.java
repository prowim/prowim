...
/**
 * Exposes {@link MainController#bendControlFlow(String, String, String, String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFBendControlFlow extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFBendControlFlow(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().bendControlFlow(argList.get(0), argList.get(1), argList.get(2), argList.get(3), argList.get(4));
    }
}

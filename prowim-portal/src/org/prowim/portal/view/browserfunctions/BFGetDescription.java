...
/**
 * Exposes {@link MainController#getDescription(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFGetDescription extends AbstractModelEditorFunction
{
     ...
     */
    BFGetDescription(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        String description = MainController.getInstance().getDescription(argList.get(0));
        if (description != null)
            return description;
        else
            return "";

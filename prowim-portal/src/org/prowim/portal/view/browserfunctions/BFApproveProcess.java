...
/**
 * Exposes {@link MainController#approveProcess(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFApproveProcess extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFApproveProcess(ModelEditor modelEditor, String name)
    {
    ...
    {
        MainController.getInstance().approveProcess((String) arguments[0]);
        return null;
    }
}

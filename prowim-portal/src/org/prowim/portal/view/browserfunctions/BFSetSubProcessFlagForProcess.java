...
/**
 * Exposes {@link MainController#setSubProcessFlagForProcess(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFSetSubProcessFlagForProcess extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFSetSubProcessFlagForProcess(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        MainController.getInstance().setSubProcessFlagForProcess(argList.get(0));
        return null;
    }
}

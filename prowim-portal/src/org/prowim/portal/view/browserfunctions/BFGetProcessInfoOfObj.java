...
/**
 * Exposes {@link MainController#getProcessInformationID(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFGetProcessInfoOfObj extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFGetProcessInfoOfObj(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().getProcessInformationID(argList.get(0));
    }
}

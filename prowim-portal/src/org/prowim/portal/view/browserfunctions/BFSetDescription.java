...
/**
 * Exposes {@link MainController#setDescription(String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFSetDescription extends AbstractModelEditorFunction
{
     ...
     */
    BFSetDescription(ModelEditor modelEditor, String name)
    {
    ...
    {
        MainController.getInstance().setDescription((String) arguments[0], (String) arguments[1]);
        return null;
    }
}

...
/**
 * Returns all {@link Mean}s which connected to the given {@link Activity}.
 * 
 * @author Maziar Khodaei
 * @version $Revision$
 * @since 2.0.0 a10
 */
public class BFGetActivityMeans extends AbstractModelEditorFunction
{
     ...
     */
    BFGetActivityMeans(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] args)
    {
        ...
        Object[] array = new Object[meanList.size()];

        for (int i = 0; i < meanList.size(); i++)
        {
            array[i] = meanList.get(i).getName();
        }

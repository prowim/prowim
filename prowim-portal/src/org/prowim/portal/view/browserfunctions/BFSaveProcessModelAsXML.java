...
/**
 * Provides access to {@link MainController#loadProcessAsXML(String) as a ModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFSaveProcessModelAsXML extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFSaveProcessModelAsXML(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        {
            InformationDialog.openInformation(null, Resources.Frames.Dialog.Texts.SAVE_MODEL_PLEASE_WAIT.getText());
            MainController.getInstance().saveProcessAsXML(modelEditor.getModelId(), modelEditor.getModelXML(), false, null);
            InformationDialog.openInformation(null, Resources.Frames.Dialog.Texts.SAVE_MODEL_SUCCESS.getText());
        }
        else
        {

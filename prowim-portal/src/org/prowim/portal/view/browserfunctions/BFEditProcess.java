 ...
 * $LastChangedRevision$
 *------------------------------------------------------------------------------
 * (c) 10.09.2010 Ebcot Business Solutions GmbH. More info: http://www.ebcot.de
...
/**
 * Edits the process model of given {@link Process} id.
 * 
 * @author Saad Wardi
 * @version $Revision$
 * @since 2.0
 */
public class BFEditProcess extends AbstractModelEditorFunction
{
     ...
     */
    BFEditProcess(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] args)
    {
        ...
        try
        {
            ...
            viewPart = window.getActivePage().showView(ModelEditorView.ID, subProcessID, IWorkbenchPage.VIEW_ACTIVATE);
            ModelEditorView modelEditorView = (ModelEditorView) viewPart;
            modelEditorView.setProcessId(subProcessID);

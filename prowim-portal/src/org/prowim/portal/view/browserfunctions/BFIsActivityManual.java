 ...
 * $LastChangedRevision$
 *------------------------------------------------------------------------------
 * (c) 17.08.2010 Ebcot Business Solutions GmbH. More info: http://www.ebcot.de
...
/**
 * function to decided if a given activity is an auto activity
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a10
 */
public class BFIsActivityManual extends AbstractModelEditorFunction
{
     ...
     */
    BFIsActivityManual(ModelEditor modelEditor, String name)
    {
    ...
    {
        return MainController.getInstance().isActivityManual(ArgumentValidator.convert(arguments).get(0));
    }

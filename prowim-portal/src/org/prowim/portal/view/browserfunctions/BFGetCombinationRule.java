...
/**
 * Exposes {@link MainController#getCombinationRule(String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFGetCombinationRule extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFGetCombinationRule(ModelEditor modelEditor, String name)
    {
    ...
    public Object function(Object[] arguments)
    {
        ...
        return MainController.getInstance().getCombinationRule(argList.get(0));
    }
}

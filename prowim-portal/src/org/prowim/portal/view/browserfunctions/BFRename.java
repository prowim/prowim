...
/**
 * Exposes {@link MainController#rename(String, String)} as {@link AbstractModelEditorFunction}.
 * 
 * @author Philipp Leusmann
 * @version $Revision$
 * @since 2.0.0a8
 */
public class BFRename extends AbstractModelEditorFunction
{
    /**
     ...
     */
    BFRename(ModelEditor modelEditor, String name)
    {
    ...
    {
        MainController.getInstance().rename((String) arguments[0], (String) arguments[1]);
        return null;
    }
}

 ...
 * @since 7.3a
 */
public class ActivityLabelProvider extends DefaultTableLabelProvider
{
    ...
    public String getColumnText(Object element, int columnIndex)
    {
        ...
        switch (columnIndex)
        {
            ...
            case 2:
                return new DateTime(new Long(activity.getStartTime())).toString(DateTimeFormat.forPattern(GlobalConstants.DATE_TIME_GR_PATTERN));
            default:
                return "";
        }
    }

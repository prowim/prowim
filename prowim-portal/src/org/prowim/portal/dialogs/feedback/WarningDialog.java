 ...
 * $LastChangedRevision$
 *------------------------------------------------------------------------------
 * (c) 08.02.2010 Ebcot Business Solutions GmbH. More info: http://www.ebcot.de
...
/**
 * Default Dialog for warning messages.
 * 
...
public final class WarningDialog extends MessageDialog
{
     ...
     */
    private WarningDialog(Shell parentShell, String dialogTitle, Image dialogTitleImage, String dialogMessage, int dialogImageType,
    ...
    /**
     * {@link MessageDialog#openWarning(Shell, String, String)}.
     * 
     * @param parent parent shell.
     * @param message the header Title.
     */
    public static void openWarning(Shell parent, String message)
    {
        MessageDialog.openWarning(parent, Resources.Frames.Dialog.Texts.WARNING_TITLE.getText(), message);
    }

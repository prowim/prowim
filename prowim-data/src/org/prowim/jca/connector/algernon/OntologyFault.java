 ...
 * @since 2.0.0a9
 */
@XmlType(name = "ontologyFault", namespace = "org.prowim.jca.connector.algernon", propOrder = { "message" })
public class OntologyFault
{
    private String message;

    /**
     * Constructs this {@link OntologyFault fault}.
     */
    public OntologyFault()
    {
    }
     ...
     * 
     * @return the message, can be <code>NULL</code>
     */

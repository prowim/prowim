 ...
 * Project: ProWim
 * $LastChangedBy: wardi $
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/datamodel/collections/ParameterArray.java $
 *------------------------------------------------------------------------------
...
/**
 * a Class for the {@link Parameter} list that will be transmited from server to the client.
 * 
 * @author Saad Wardi
...
public class ParameterArray implements Collection<Parameter>
{
     ...
     */
    public void setItem(List<Parameter> itemList)
    {
        this.item = itemList;
    }

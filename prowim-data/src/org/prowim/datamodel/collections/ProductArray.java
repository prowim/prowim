 ...
 * Project: ProWim
 *
 * $LastChangedDate: 2009-08-04 14:50:28 +0200 (Di, 04 Aug 2009) $
 * $LastChangedBy: wardi $
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/datamodel/collections/ProductArray.java $
 * $LastChangedRevision: 2109 $
 *------------------------------------------------------------------------------
...
/**
 * a Class for the {@link Product} list that will be transmited from server to the client.
 * 
 * @author Saad Wardi
...
@XmlType(name = "ProductArray", propOrder = { "item" })
public class ProductArray implements Collection<Product>
{
     ...
     */
    public void setItem(List<Product> itemList)
    {
        this.item = itemList;
    }

...
/**
 * a Class for all Object values list that will be transmited from server to the client.
 * 
 * @author Saad Wardi
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "objectArray", propOrder = { "item" })
public class ObjectArray implements Collection<Object>
{
    /** the Object list. */

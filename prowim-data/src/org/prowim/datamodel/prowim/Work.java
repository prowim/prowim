 ...
 * $LastChangedBy: wardi $
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/datamodel/prowim/Work.java $
...
/**
 * This is a data-object-class represents work.
 * 
 * @author Saad Wardi
...
@XmlType(namespace = "org.prowim.datamodel.prowim", name = "Work", propOrder = {})
public class Work extends ProcessElement
{
    /**
     * {@link ProcessElement}.
     * 
     ...
     */
    protected Work(String id, String name, String createTime)
    {

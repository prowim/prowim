...
@XmlType(namespace = "org.prowim.datamodel.prowim", name = "Conjunction", propOrder = {})
public class Conjunction extends ProcessElement implements Comparable<Object>
{
     ...
     * 
     * @param id the id of the conjunction
     * @param name the name of the conjunction
     * @param createTime the creation time of the conjunction
     */
    public Conjunction(String id, String name, String createTime)
    {

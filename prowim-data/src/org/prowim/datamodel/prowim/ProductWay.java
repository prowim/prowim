 ...
 * $LastChangedBy: wardi $
 * $HeadURL: https://repository.ebcot.info/wivu/trunk/prowim-server/src/de/ebcot/prowim/datamodel/prowim/ProductWay.java $
...
/**
 * This is a data-object-class represents productway.
 * 
 * @author Saad Wardi
 * @version $Revision: 2970 $
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "ProductWay")
@XmlType(namespace = "org.prowim.datamodel.prowim", name = "ProductWay", propOrder = {})
public class ProductWay extends ProcessElement
{
     ...
     */
    protected ProductWay(String id, String name, String createTime)
    {

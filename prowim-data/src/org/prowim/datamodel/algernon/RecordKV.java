...
/**
 * All columns of one record set, called Record Knowledgebase Value. One field is one column.
 * 
 * @author Saad Wardi
...
@XmlType(name = "recordKV", propOrder = { "fields", "noOfFields" })
public class RecordKV
{
     ...
     * 
     * @param noOfFields the numberOfFields to set
     */
    public void setNumberOfFields(int noOfFields)
    {

...
/**
 * A JCA data source which provides a managed {@link Connection connections} to a protege project.
 * 
...
public interface DataSource extends Serializable, Referenceable
{
    /**
     * 
     * Creates or allocates a connection.
     * 
     * @return a connection, can not be <code>NULL</code>
     */
